  ...
  return (
    <>
      ...
      <div className="float-right flex mr-6 gap-2 mb-4  mt-[-1rem]" >
        <Button
          text={"Hủy"}
          Class={"flex font-medium items-center text-black hover:bg-slate-200 transition ease-in-out font-bold py-2 px-4 border-2 rounded-lg"}
          Icon={
            function Icon() {
              return (
        ...
        <Button
          text={"Thêm"}
          Class={"flex font-medium items-center bg-indigo-500 hover:bg-indigo-700 transition ease-in-out text-white font-bold py-2 px-4 rounded-lg  "}
          Icon={
            function Icon() {
              return (
