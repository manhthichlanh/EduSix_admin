...
// import TableEightCols from "./../../components/Table/TableEightCols";
// import TableThreeCols from "../../components/Table/TableThreeCols";
export default function Home() {
  return (
    <div>
      <div className="grid grid-cols-1 gap-6 px-6 py-4 sm:grid-cols-2 lg:grid-cols-4">
        <Card
          icon={
            <svg
              className="mb-2"
        ...
        <Card
          ...
          title="Số khóa học"
          total="1504"
          onClick={() => console.log("When I leave, I'm just a boy")}
        ></Card>
        <Card
          icon={
            <svg
          ...
          title="Người dùng"
          total="2508"
          onClick={() => console.log("When I come back, I'll be a man")}
        ></Card>
        <Card
          icon={
            <svg
      ...
      {/* <TableEightCols
        ...
        column7Title="Thời gian"
        column8Title="Thao tác"
      ></TableEightCols> */}
    </div>
  );
}
