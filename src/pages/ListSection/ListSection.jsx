...
import TableSectionMenu from "../../components/Table/Course/TableLesionMenu";
  ...
  return (
    <div className="px-6 py-6 max-h-full">
      <div className="items-end justify-between mb-6">
        {/* Breadcrumbs */}
        <div className="">
          <div className="text-2xl font-medium pb-4">Danh sách phần học</div>
          <div className="flex items-center gap-2 whitespace-nowrap">
            <a href="/" className="text-indigo-500 text">
              Trang chủ
            </a>
            <FontAwesomeIcon icon={faAngleRight} className="" />
            <p className="">Danh sách phần học</p>
          </div>
        </div>
      </div>
      {/* filter button*/}
      <div className="w-full">
        ...
        <div className="mt-6">
          <TableSectionMenu></TableSectionMenu>
        </div>
      </div>
    </div>
  );
