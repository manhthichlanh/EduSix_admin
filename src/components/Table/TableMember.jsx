                ...
                <tbody className="rounded-xl">
                    {data.map((item, index) => (
                        ...
                        >
                            ...
                            <td
                                className={`px-6 py-6 font-bold min-h-60 ${item.price === "0" ? "text-gray-500" : "text-red-500"
                                    }`}
                            >
                            ...
                            <td className="px-6 py-6">
                                <p
                                    className={`py-1 px-2 inline-block font-medium ${item.status === "active"
                                            ? "text-blue-500 bg-blue-100"
                                            : "text-green-600 bg-green-100"
                                        } rounded-lg`}
                                >
                                    {item.status === "active" ? "Đang học" : "Đã hoàn thành"}
                                </p>
                            </td>
                            <td className="px-6 py-6 font-medium text-gray-500 ">
                                {item.date}
