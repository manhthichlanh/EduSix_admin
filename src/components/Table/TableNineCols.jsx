...
const data = [
  {
    id: "1",
    courseName:
      "When I left, I was just a boy. When I return, I'll be a man. When I come back, the first thing I will do is find you and I will say: I'm not perfect but I'll love you by the most perfect way",
    category: "Danh mục 1",
    numberOfLessons: "12",
    price: "200,000",
    status: "Active",
        ...
        <table className="w-full xl:table-auto">
          <thead className="bg-neutral-100">
            <tr className="font-sans rounded-lg whitespace-nowrap">
              ...
              <td className="px-6 py-4 font-medium">{column9Title}</td>
            </tr>
          </thead>
          <tbody className="rounded-xl">
            {data.map((item, index) => (
              ...
              >
                <td className="px-6 py-4 xl:line-clamp-4 min-w-[200px] lg:line-clamp-3 lg:min-w-[300px]">
                  <div className="text-base font-medium line-clamp-3 md:line-clamp-2">
                    {item.courseName}
                  </div>
                </td>
                <td className="px-6 py-6 font-medium text-blue-500 whitespace-nowrap">
                  {item.id}
                </td>
                ...
                <td className="px-6 py-6">
                  <p
                    className={`py-1 px-2 inline-block font-medium whitespace-nowrap ${
                      item.status === "Active"
                    ...
                    <Button
                      Icon={function Icon() {
                        return (
                          ...
                          >
                            <path
                              d="M10 9.75C10.5523 9.75 11 10.1977 11 10.75V16.75C11 17.3023 10.5523 17.75 10 17.75C9.44772 17.75 9 17.3023 9 16.75V10.75C9 10.1977 9.44772 9.75 10 9.75Z"
                              fill="currentColor"
                            />
                            <path
                              d="M15 10.75C15 10.1977 14.5523 9.75 14 9.75C13.4477 9.75 13 10.1977 13 10.75V16.75C13 17.3023 13.4477 17.75 14 17.75C14.5523 17.75 15 17.3023 15 16.75V10.75Z"
                              fill="currentColor"
                            />
                            <path
                              fill-rule="evenodd"
                      ...
                      onClick={() => console.log("I like you")}
                    ></Button>
                  </div>
                </td>
              </tr>
